...
log_reg = LogisticRegression(max_iter=500, random_state=42, solver='liblinear', C=1, penalty='l2')
...
if uploaded_file is not None:
    ...
    # Predict Attrition
    user_df['Attrition'] = log_reg.predict(user_df)
    ...
    if st.button('Predict'):
        user_prediction = log_reg.predict(user_df)
        user_prediction_prob = log_reg.predict_proba(user_df)[:, 1]
